...
/**
 * Class of ClassicSudoku, extending BasePuzzle. It contains the basic classic
 * 9x9 sudoku puzzle and its basic functions.
 *
 * @author Anthony
 */
public class ClassicSudoku extends BasePuzzle {
    ...
    /**
     * Boolean matrix, showing if a cell can be editable, or if it was loaded by
     * default.
     */
    ...
    //ctor
    /**
     * ctor Initializing sudoku's variables.
     */
     ...
     * start, as well as the puzzle's id.
     *
     * @param arrayToLoad
     */
    ...
    /**
     * Getter function, that returns the matrix containing which cells are
     * editable or not.
     *
     * @return
     */
