...
/**
 * Abstract class representing a puzzle. It is parent class of the sudoku puzzles
 * and can be used for other type of puzzles as well.
 * @author Anthony
 */
public abstract class BasePuzzle implements Serializable {
    ...
    /**
     * Makes the necessary checks when inserting a value in the matrix. Checks
     * dimensions, input and rules of the puzzle.
     *
    ...
    /**
     * Makes the necessary bound checks for the position in the matrix, when
     * inserting a value.
     *
     * @param x the x coordinate of the cell
     * @param y the y coordinate of the cell
