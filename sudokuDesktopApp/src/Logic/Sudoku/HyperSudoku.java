...
public class HyperSudoku extends ClassicSudoku {
    ...
    /**
     * ArrayList that contains all cells that represent the start of an inner
     * sudoku block.
     */
     ...
     * Initializes at -1. Anything else (1,2,3,4) indicates the innersudoku in
     * which the cell is.
     */
    private int[][] sudokuMatrix;

    /**
     * Default constructor. Creates for inner sudokus, with the following upper
     * left corners: (zero based, as in Coord_2D) 1,1 1,5 5,1 5,5
     */
    public HyperSudoku() {
    ...
    /**
     * Constructor of HyperSudoku. Requires 4 parameters of the inner sudokus'
     * upper left corner.
     *
    ...
    /**
     * Helper function that checks if everything is valid with the inner sudokus
     * provided.
     *
