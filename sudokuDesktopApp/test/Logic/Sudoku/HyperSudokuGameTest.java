...
public class HyperSudokuGameTest {
     ...
     **/
     ...
     public void testOnQuitGame() {
         g = new HyperSudokuGame(dummyMatrix(), "1", new Person("Test"));
         g.onQuitGame(true);
         HyperSudokuGame gTest= (HyperSudokuGame) IO.readFromFile(GlobalConstants.SAVES_PATH + g.players.get(0).getId()+"_prev");
